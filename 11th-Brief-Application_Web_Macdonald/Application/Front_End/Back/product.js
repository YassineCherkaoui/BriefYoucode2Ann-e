...
class UI {
  displayProducts(products) {
    ...
    products.forEach(({ nom, prix, _id }) => {
      ...
      <div class="product">
      <div class="card">
      <img class="card-img-top" src="https://cdn.pixabay.com/photo/2016/05/25/10/43/hamburger-1414422_960_720.jpg" alt="Card image cap"style="
      width: 37%;
  ">
      <div class="card-body">
        ...
        <button class="btn btn-primary addToCart" data-id= ${_id} >Add to Cart</button>
      </div>
    </div>
    </div>
    <div class="blink" style="margin: 3%;"></div>
      `;
    });
